...
## LiteX reference SoC map

The Stage 1 LiteX/VexRiscvSMP Linux reference SoC intentionally uses the map generated by LiteX, not the draft custom map above:

```text
0x0000_0000 - 0x0001_FFFF    boot ROM / reset vector area
0x1000_0000 - 0x1000_1FFF    small integrated SRAM
0x4000_0000 - 0x47FF_FFFF    DDR2, 128 MiB
0x40F0_0000 - 0x40F7_FFFF    OpenSBI reserved region inside DDR
0xF000_0000 - 0xF000_FFFF    LiteX CSR window
0xF001_0000 - 0xF001_FFFF    CLINT
0xF0C0_0000 - 0xF0FF_FFFF    PLIC
```

Use this generated map for the reference Linux boot path. Keep the draft conventional map as the target shape for the later custom CPU/SoC path unless there is a strong reason to stay with LiteX addresses.
